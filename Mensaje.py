...
MENSAJE_ARCHIVO_TURNOS = "Archivo invalido, verifique que el archivo sea de tipo .csv, .xls o .xlsx y que dentro tenga 1 columna con nombres y nombres de día de la semana"
